...
- Firstly, you need to know where your shapefile is on your computer.

- Secondly, you need to know R's current working directory. (In RStudio look under the Files tab, and navigate to the desired working directory and use the More dropdown to set it as current working directory. Alternatively, use `getwd()` and `setwd()` from the R command prompt.)
...
2. Set your working directory to the `R_Workshop` folder and make sure it contains the materials you downloaded and unzipped earlier.
