...
You should perhaps also be aware that a recently released R package [`sf`](https://cran.r-project.org/package=sf
) which [approaches the modeling of spatial objects in a very different way](https://edzer.github.io/sfr/articles/sfr.html).
