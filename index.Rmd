...
- Spatial operations in R (requires knowledge about R spatial data types) 

_Nov 14, 2016, 3-5pm:_

- Making maps in R  (requires knowledge about R spatial data types)
- Geocoding in R (requires knowledge about R spatial data types)
